...
(cd $WILDFLY_HOME/bin && JAVA_HOME='C:\DEV\java\jdk-1.8.0-66_H03-win_x64' ./standalone.bat -Djboss.socket.binding.port-offset=0 --debug --server-config=standalone-full.xml)
